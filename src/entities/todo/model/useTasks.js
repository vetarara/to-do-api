...
// useReducer есть смысл подключать, когда есть несколько операций над одним и тем же набором данных
// он помогает держать все правила изменения конкретного состояния в одном месте
  ...
  const deleteAllTasks = useCallback(() => {
    ...
    if (isConfirmed) {
      tasksAPI.deleteAll(tasks)
        // сообщаем функции-reducer о выполнении действия удаления, reducer сам выполнит это действие
